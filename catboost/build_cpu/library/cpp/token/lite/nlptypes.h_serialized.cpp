...
namespace { namespace NNLP_TYPEPrivate {
    ...
    static constexpr const TNameBufsBase::TInitializationData ENUM_INITIALIZATION_DATA{
        ...
        ::NEnumSerializationRuntime::CommonStringBuffer(""sv, "NLP_TYPE"sv).first,
        ::NEnumSerializationRuntime::CommonStringBuffer(""sv, "NLP_TYPE"sv).second,
    };
...
namespace { namespace NESpaceTypePrivate {
    ...
    static constexpr const TNameBufsBase::TInitializationData ENUM_INITIALIZATION_DATA{
        ...
        VALUES_INITIALIZATION_PAIRS,
        CPP_NAMES_INITIALIZATION_ARRAY,
        ::NEnumSerializationRuntime::CommonStringBuffer(""sv, "ESpaceType"sv).first,
        ::NEnumSerializationRuntime::CommonStringBuffer(""sv, "ESpaceType"sv).second,
    };
