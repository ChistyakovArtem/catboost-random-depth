...
namespace { namespace NNJsonEJsonValueTypePrivate {
    ...
    static constexpr const TNameBufsBase::TInitializationData ENUM_INITIALIZATION_DATA{
        ...
        ::NEnumSerializationRuntime::CommonStringBuffer("NJson::"sv, "NJson::EJsonValueType"sv).first,
        ::NEnumSerializationRuntime::CommonStringBuffer("NJson::"sv, "NJson::EJsonValueType"sv).second,
    };
