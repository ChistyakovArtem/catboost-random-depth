...
namespace { namespace NEBorderSelectionTypePrivate {
    ...
    static constexpr const TNameBufsBase::TInitializationData ENUM_INITIALIZATION_DATA{
        ...
        ::NEnumSerializationRuntime::CommonStringBuffer("EBorderSelectionType::"sv, "EBorderSelectionType"sv).first,
        ::NEnumSerializationRuntime::CommonStringBuffer("EBorderSelectionType::"sv, "EBorderSelectionType"sv).second,
    };
...
namespace { namespace NNSplitSelectionNImplEPenaltyTypePrivate {
    ...
    static constexpr const TNameBufsBase::TInitializationData ENUM_INITIALIZATION_DATA{
        ...
        VALUES_INITIALIZATION_PAIRS,
        CPP_NAMES_INITIALIZATION_ARRAY,
        ::NEnumSerializationRuntime::CommonStringBuffer("NSplitSelection::NImpl::EPenaltyType::"sv, "NSplitSelection::NImpl::EPenaltyType"sv).first,
        ::NEnumSerializationRuntime::CommonStringBuffer("NSplitSelection::NImpl::EPenaltyType::"sv, "NSplitSelection::NImpl::EPenaltyType"sv).second,
    };
...
namespace { namespace NNSplitSelectionNImplEOptimizationTypePrivate {
    ...
    static constexpr const TNameBufsBase::TInitializationData ENUM_INITIALIZATION_DATA{
        ...
        VALUES_INITIALIZATION_PAIRS,
        CPP_NAMES_INITIALIZATION_ARRAY,
        ::NEnumSerializationRuntime::CommonStringBuffer("NSplitSelection::NImpl::EOptimizationType::"sv, "NSplitSelection::NImpl::EOptimizationType"sv).first,
        ::NEnumSerializationRuntime::CommonStringBuffer("NSplitSelection::NImpl::EOptimizationType::"sv, "NSplitSelection::NImpl::EOptimizationType"sv).second,
    };
