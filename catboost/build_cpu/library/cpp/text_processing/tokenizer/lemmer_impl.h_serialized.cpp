...
namespace { namespace NNTextProcessingNTokenizerEImplementationTypePrivate {
    ...
    static constexpr const TNameBufsBase::TInitializationData ENUM_INITIALIZATION_DATA{
        ...
        ::NEnumSerializationRuntime::CommonStringBuffer("NTextProcessing::NTokenizer::EImplementationType::"sv, "NTextProcessing::NTokenizer::EImplementationType"sv).first,
        ::NEnumSerializationRuntime::CommonStringBuffer("NTextProcessing::NTokenizer::EImplementationType::"sv, "NTextProcessing::NTokenizer::EImplementationType"sv).second,
    };
