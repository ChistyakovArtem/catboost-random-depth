...
namespace { namespace NNTextProcessingNTokenizerESeparatorTypePrivate {
    ...
    static constexpr const TNameBufsBase::TInitializationData ENUM_INITIALIZATION_DATA{
        ...
        ::NEnumSerializationRuntime::CommonStringBuffer("NTextProcessing::NTokenizer::ESeparatorType::"sv, "NTextProcessing::NTokenizer::ESeparatorType"sv).first,
        ::NEnumSerializationRuntime::CommonStringBuffer("NTextProcessing::NTokenizer::ESeparatorType::"sv, "NTextProcessing::NTokenizer::ESeparatorType"sv).second,
    };
...
namespace { namespace NNTextProcessingNTokenizerETokenTypePrivate {
    ...
    static constexpr const TNameBufsBase::TInitializationData ENUM_INITIALIZATION_DATA{
        ...
        VALUES_INITIALIZATION_PAIRS,
        CPP_NAMES_INITIALIZATION_ARRAY,
        ::NEnumSerializationRuntime::CommonStringBuffer("NTextProcessing::NTokenizer::ETokenType::"sv, "NTextProcessing::NTokenizer::ETokenType"sv).first,
        ::NEnumSerializationRuntime::CommonStringBuffer("NTextProcessing::NTokenizer::ETokenType::"sv, "NTextProcessing::NTokenizer::ETokenType"sv).second,
    };
...
namespace { namespace NNTextProcessingNTokenizerESubTokensPolicyPrivate {
    ...
    static constexpr const TNameBufsBase::TInitializationData ENUM_INITIALIZATION_DATA{
        ...
        VALUES_INITIALIZATION_PAIRS,
        CPP_NAMES_INITIALIZATION_ARRAY,
        ::NEnumSerializationRuntime::CommonStringBuffer("NTextProcessing::NTokenizer::ESubTokensPolicy::"sv, "NTextProcessing::NTokenizer::ESubTokensPolicy"sv).first,
        ::NEnumSerializationRuntime::CommonStringBuffer("NTextProcessing::NTokenizer::ESubTokensPolicy::"sv, "NTextProcessing::NTokenizer::ESubTokensPolicy"sv).second,
    };
...
namespace { namespace NNTextProcessingNTokenizerETokenProcessPolicyPrivate {
    ...
    static constexpr const TNameBufsBase::TInitializationData ENUM_INITIALIZATION_DATA{
        ...
        VALUES_INITIALIZATION_PAIRS,
        CPP_NAMES_INITIALIZATION_ARRAY,
        ::NEnumSerializationRuntime::CommonStringBuffer("NTextProcessing::NTokenizer::ETokenProcessPolicy::"sv, "NTextProcessing::NTokenizer::ETokenProcessPolicy"sv).first,
        ::NEnumSerializationRuntime::CommonStringBuffer("NTextProcessing::NTokenizer::ETokenProcessPolicy::"sv, "NTextProcessing::NTokenizer::ETokenProcessPolicy"sv).second,
    };
