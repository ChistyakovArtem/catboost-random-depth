...
namespace { namespace NNCBEDistributionTypePrivate {
    ...
    static constexpr const TNameBufsBase::TInitializationData ENUM_INITIALIZATION_DATA{
        ...
        ::NEnumSerializationRuntime::CommonStringBuffer("NCB::EDistributionType::"sv, "NCB::EDistributionType"sv).first,
        ::NEnumSerializationRuntime::CommonStringBuffer("NCB::EDistributionType::"sv, "NCB::EDistributionType"sv).second,
    };
