...
namespace { namespace NNCBESparseArrayIndexingTypePrivate {
    ...
    static constexpr const TNameBufsBase::TInitializationData ENUM_INITIALIZATION_DATA{
        ...
        ::NEnumSerializationRuntime::CommonStringBuffer("NCB::ESparseArrayIndexingType::"sv, "NCB::ESparseArrayIndexingType"sv).first,
        ::NEnumSerializationRuntime::CommonStringBuffer("NCB::ESparseArrayIndexingType::"sv, "NCB::ESparseArrayIndexingType"sv).second,
    };
