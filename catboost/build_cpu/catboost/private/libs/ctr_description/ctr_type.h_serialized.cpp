...
namespace { namespace NECtrTypePrivate {
    ...
    static constexpr const TNameBufsBase::TInitializationData ENUM_INITIALIZATION_DATA{
        ...
        ::NEnumSerializationRuntime::CommonStringBuffer("ECtrType::"sv, "ECtrType"sv).first,
        ::NEnumSerializationRuntime::CommonStringBuffer("ECtrType::"sv, "ECtrType"sv).second,
    };
...
namespace { namespace NECtrHistoryUnitPrivate {
    ...
    static constexpr const TNameBufsBase::TInitializationData ENUM_INITIALIZATION_DATA{
        ...
        VALUES_INITIALIZATION_PAIRS,
        CPP_NAMES_INITIALIZATION_ARRAY,
        ::NEnumSerializationRuntime::CommonStringBuffer("ECtrHistoryUnit::"sv, "ECtrHistoryUnit"sv).first,
        ::NEnumSerializationRuntime::CommonStringBuffer("ECtrHistoryUnit::"sv, "ECtrHistoryUnit"sv).second,
    };
